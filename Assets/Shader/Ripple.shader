...
#include "UnityCG.cginc"
			...
			fixed3 shift_col(fixed3 RGB, half3 shift)
			{
				...
				float VSU = shift.z * shift.y * cos(shift.x * 3.14159263 / 180);
				float VSW = shift.z * shift.y * sin(shift.x * 3.14159263 / 180);
